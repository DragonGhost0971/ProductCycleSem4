...
Структура обеспечивает полноту документирования процесса распределенной разработки конструкции изделия с использованием современных международных стандартов технической документации.
